...
const EditForm = ({product}) => {
    ...
    return (<Formik initialValues={{ name: product.name, description: product.description, price: product.price, category: product.category, quantity: product.quantity, image: product.image }}
        ...
        onSubmit={(values) => {
            ...
            axiosInstance.put(`products/${product._id}/`, form_data).then((res) => {
